...
<b>PROJECT - RANGMANCH </b>
 ...
 <img src={require('../images/pika.jpg')} alt="Smiley face" width="400" height="300" hspace="20" align="left"/>
 ...
 <img src={require('../images/pika.jpg')} alt="Smiley face" width="100" height="100" hspace="10" align="left"/>
  <img src={require('../images/pika.jpg')} alt="Smiley face" width="100" height="100" hspace="10" align="middle"/>
   <img src={require('../images/pika.jpg')} alt="Smiley face" width="100" height="100" hspace="10" align="right"/>
</p>
